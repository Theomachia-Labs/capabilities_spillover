...
@st.cache_data
def load_data():
    file_path = Path(__file__).parent.parent / "data_sample" / "mock_csp_data.json"
...
# Keys must match topic_name in mock data.
# ---------------------------------------------------------------------------
...
# Color-code by dominant topic cluster
CLUSTER_COLORS = {
...
# ---------------------------------------------------------------------------
# Detail panels — expandable per paper
# ---------------------------------------------------------------------------
